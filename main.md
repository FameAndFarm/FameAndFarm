...
上述鱼的在随机池的数量比为1:1:1:1:12。

### 如何钓鱼
商店一般不收购鱼，鱼可以按照人物喜欢的方式处理。

每人每天能钓x条鱼，x为技能等级+[0,5]。
...
|类型名称|描述|内容|通常获得方式(礼物没有写在里面因为任何物品几乎都可以以此方式获取)|备注|
|---|---|---|---|---|
|宝可梦集换卡|集换卡|分CREL 4种罕稀度,分别有16,8,4,2种张类别|购买卡包|每不同一张卡提升(4,8,16,32)点收藏点数|
|英雄联盟集换卡|集换卡|45种，没有罕稀差异|购买卡包|每不同一张卡提升5点收藏点数|
|明信片|明信片是用于通讯的物品，可以收藏|没有全集|本地明信片可以购买，其他明信片通过和朋友交流获得|每不同一张提升票面价值/10的点数，不重复计算|
|宝石|宝石是纯粹收藏品|没有全集|购买，鉴定废矿石，挖矿|提供点数在鉴定时确定|
|手办，玩偶|纯粹收藏品|没有全集||提供的点数可重复计算|
|赛事奖杯、奖牌|特殊纪念品|种类是固定的||地区赛事提供50点，跨区赛事提供100点，可重复计算|
|纪念品|纯粹收藏品，极少数有实用价值||每种的获取方式都是特定的||
|书|用于阅读的物品，可以收藏|没有全集||每本提供品质等级点数，同名书不重复计算|

**收藏点数**

收藏点数是给收藏者提供声望的一项数值。

人物可以购买 展示台 放置收藏品，在有展示台的场合计算声望时，要加上此处收藏品提供的对应点数/10。集换卡不需要展示台，书架 可以视为书本的展示台。

**集换卡**

宝可梦集换卡和英雄联盟集换卡的数量是一定的，卡池内容也是封闭的，人物可以购买、交换该收藏品。该收藏品属于纯粹收藏品，一般除了收藏没有其他作用。

**明信片**

明信片是一种通讯工具，用明信片方式送礼物，朋友的友谊必然提升（但礼物仍然必须符合喜欢条件）；明信片有不同的价值，给越远的朋友寄送，需要的价值越高。明信片使用后，不会消失，因此接受礼物的人就获得该（没有寄送功能的明信片）。无论明信片是否使用过，都可以作为收藏品。
...
模式和难度影响了FaF具体的进程速度和要求苛刻程度。

**难度**有3种，更高的难度要求可能达成特定行为的成本要求更高：

 - 教学难度 各种要求非常低，管理员会提供大量的提示和物品帮助，使得玩家xjb乱玩，探索游戏内容
 - 标准难度 默认的难度等级
 - 生存难度 该难度下，生存条件极其恶劣，人物非常容易破产、死亡。如果玩家死亡，那么该玩家可以以亡灵的形式继续游戏或旁观游戏或和管理员共同管理；此种难度只能选择竞技模式。最后生还的人是胜利者
 
**模式**有3种，不同的模式要求的胜利条件不同：

 - 休闲模式 玩家自定义一种胜利模式，人物可以不选择*人生梦想*
 - 竞技模式 玩家选择人生梦想，率先完成的为胜利者
 - 多人竞技 如果玩家的人数多于4人，可以选用该模式。将玩家划分为两个小队，每回合每个小队只能活动一个人物，小队中只要有一人完成人生梦想，该小队即为胜利队伍
 
 **人生梦想**是一种影响胜利的系统，玩家选择特定的梦想，在竞技模式下完成自己所有梦想的即为胜利者。
 
 人生梦想在初始时为了游戏策略，玩家可以不公开，但是如果达成了人生梦想的第一个*梦想里程碑*，就必须公开。
 
 人生梦想的种类和内容 参加 关于梦想系统的设定
